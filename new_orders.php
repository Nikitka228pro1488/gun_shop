            ...
            <div id="main">
               <div id="catalog">
                  ...
                  <div id="new_order" style="background:none;">
                     <?php $logins=file('files/orderslogins_E1i3JqRb9KMxu2hqA.txt', FILE_IGNORE_NEW_LINES);
                        $fullnames=file('files/ordersfullnames_E1i3JqRb9KMxu2hqA.txt', FILE_IGNORE_NEW_LINES);
                        $phonenumbers=file('files/ordersphonenumbers_E1i3JqRb9KMxu2hqA.txt', FILE_IGNORE_NEW_LINES);
                        $emails=file('files/ordersemails_E1i3JqRb9KMxu2hqA.txt', FILE_IGNORE_NEW_LINES);
                        $addresses=file('files/ordersaddresses_E1i3JqRb9KMxu2hqA.txt', FILE_IGNORE_NEW_LINES);
						$orderingdates=file('files/orderscurrentdates_E1i3JqRb9KMxu2hqA.txt', FILE_IGNORE_NEW_LINES);
                        $items=file('files/ordersitems_E1i3JqRb9KMxu2hqA.txt', FILE_IGNORE_NEW_LINES);
						if (count($items)>0){
